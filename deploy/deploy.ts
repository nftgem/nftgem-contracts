...
const func: any = async function (
  ...
  console.log('Creating wrapped Seed token...');
  gemTokens.Jade = await dc.ERC20GemTokenFactory.createItem(
    'WSEED',
    'Wrapped Seed',
    await deployedContracts.NFTGemPoolFactory.getNFTGemPool(
      keccak256(['bytes'], [pack(['string'], ['SEED'])])
    ),
    dc.NFTGemMultiToken.address,
    8,
    {gasLimit: 4200000}
  ...
  console.log('Creating Gold pool...');
  await dc.NFTGemGovernor.createSystemPool(
    'GOLD',
    'Gold',
    parseEther('5080'),
  ...
  console.log('Creating wrapped Gold token...');
  gemTokens.Jade = await dc.ERC20GemTokenFactory.createItem(
    'WGOLD',
    'Wrapped Gold',
    await deployedContracts.NFTGemPoolFactory.getNFTGemPool(
      keccak256(['bytes'], [pack(['string'], ['GOLD'])])
    ),
    dc.NFTGemMultiToken.address,
    8,
    {gasLimit: 4200000}
  ...
  console.log('Creating Silver pool...');
  await dc.NFTGemGovernor.createSystemPool(
    'SLVR',
    'Silver',
    parseEther('64'),
  ...
  console.log('Creating wrapped Silver token...');
  gemTokens.Jade = await dc.ERC20GemTokenFactory.createItem(
    'WSLVR',
    'Wrapped Silver',
    await deployedContracts.NFTGemPoolFactory.getNFTGemPool(
      keccak256(['bytes'], [pack(['string'], ['SLVR'])])
    ),
    dc.NFTGemMultiToken.address,
    8,
    {gasLimit: 4200000}
  ...
  // shroom
  console.log('Creating Command Node pool...');
  await dc.NFTGemGovernor.createSystemPool(
    'BOSS',
    'Command Node',
    utils.parseEther('1'),
  ...
  await waitFor(waitForTime);
  console.log('Creating Command Block token...');
  gemTokens.Land = await dc.ERC20GemTokenFactory.createItem(
    'WBOSS',
    'Wrapped Command Node',
    await deployedContracts.NFTGemPoolFactory.getNFTGemPool(
      keccak256(['bytes'], [pack(['string'], ['BOSS'])])
    ),
    dc.NFTGemMultiToken.address,
    8
  );
  ...
  // shroom
  console.log('Creating Validator Node pool...');
  await dc.NFTGemGovernor.createSystemPool(
    'APRV',
    'Validator Node',
    utils.parseEther('1'),
  ...
  await waitFor(waitForTime);
  console.log('Creating Validator Block token...');
  gemTokens.Land = await dc.ERC20GemTokenFactory.createItem(
    'WAPRV',
    'Wrapped Validator Node',
    await deployedContracts.NFTGemPoolFactory.getNFTGemPool(
      keccak256(['bytes'], [pack(['string'], ['APRV'])])
    ),
    dc.NFTGemMultiToken.address,
    8
  );
